class Strings {
  ...
  static const List<String> EGZERSIZ_NASIL_YAPILIR = [
    ...
    "\t1-Ayakta dik bir şekilde durun.\n\n"
        ...
        "\t3-Üst bedeninizi dik tutun, kambur durmamaya özen gösterin. \n\n"
        "\t4-Üst bacağınız yer ile paralel hale geldiği zaman pozisyonu koruyun. 4-6 kez nefes alın. \n\n"
        "\t5-Başlangıç pozisyonunuza dönüp hareketi tekrarlayabilirsiniz.\n\n",
